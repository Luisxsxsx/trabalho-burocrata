...
import src.estudantes.entidades.Burocrata;
import src.estudantes.entidades.Documento;
...
public class Universidade {
    ...
    public void simular() {
        ...
        if (secretaria.contarDocumentosDespachados() + secretaria.contarDocumentosPerdidos()
                + documentosNosMontes > Curso.getDocumentosCriados()) {
