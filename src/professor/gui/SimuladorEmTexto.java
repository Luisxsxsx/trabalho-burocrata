package src.professor.gui;

import java.util.TimerTask;
import src.professor.entidades.CodigoCurso;
import src.professor.entidades.Universidade;
...
public class SimuladorEmTexto {
    ...
    private void atualizarInterface() {
        ...
        System.out.println("--------");
        System.out.println("Monte da CC: "
                + universidade.contarDocumentosNoMonteDoCurso(CodigoCurso.GRADUACAO_CIENCIA_DA_COMPUTACAO));
        System.out.println("Monte da EA: "
                + universidade.contarDocumentosNoMonteDoCurso(CodigoCurso.GRADUACAO_ENGENHARIA_AGRICOLA));
        System.out.println(
                "Monte da EC: " + universidade.contarDocumentosNoMonteDoCurso(CodigoCurso.GRADUACAO_ENGENHARIA_CIVIL));
        System.out.println("Monte da EE: "
                + universidade.contarDocumentosNoMonteDoCurso(CodigoCurso.GRADUACAO_ENGENHARIA_ELETRICA));
        System.out.println("Monte da EM: "
                + universidade.contarDocumentosNoMonteDoCurso(CodigoCurso.GRADUACAO_ENGENHARIA_MECANICA));
        System.out.println("Monte da ES: "
                + universidade.contarDocumentosNoMonteDoCurso(CodigoCurso.GRADUACAO_ENGENHARIA_SOFTWARE));
        System.out.println("Monte da ET: "
                + universidade.contarDocumentosNoMonteDoCurso(CodigoCurso.GRADUACAO_ENGENHARIA_TELECOMUNICACOES));
        System.out.println(
                "Monte da PPGE: " + universidade.contarDocumentosNoMonteDoCurso(CodigoCurso.POS_GRADUACAO_ENGENHARIA));
        System.out.println("Monte da PPGEE: "
                + universidade.contarDocumentosNoMonteDoCurso(CodigoCurso.POS_GRADUACAO_ENGENHARIA_ELETRICA));
        System.out.println("Monte da PPGES: "
                + universidade.contarDocumentosNoMonteDoCurso(CodigoCurso.POS_GRADUACAO_ENGENHARIA_SOFTWARE));
        System.out.println("--------");
    ...
    public static void main(String[] args) {
        ...
        /*
         * começa a invocação da tarefa a cada 1 segundo, começando com 3 segundos de
         * atraso
         */
        new java.util.Timer().schedule(tarefaControle, 3000, 1000);

        /*
         * começa a invocação da tarefa a cada 100 milissegundos, começando com 3
         * segundos de atraso
         */
        new java.util.Timer().schedule(tarefaSimular, 3000, 100);

        /*
         * começa a invocação da tarefa a cada segundos, começando com 4 segundos de
         * atraso
         */
